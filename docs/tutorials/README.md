...
|---------|-------------------|------|
| [0. Welcome](00-welcome/index.md) | Introduction, setup, meet your code | 15 min |
| [1. Physics Foundations](01-physics-foundations/) | Forces, gears, friction | 45 min |
| [2. Robot Anatomy](02-robot-anatomy/) | Brain, motors, sensors | 30 min |
| [3. Python Basics](03-python-basics/) | Variables, functions, loops | 45 min |
| [4. Drive Control](04-drive-control/) | Tank drive, arcade drive | 30 min |
| [5. Autonomous](05-autonomous/) | Programming movements | 45 min |
| [6. Competition Strategy](06-competition-strategy/) | Push Back game tactics | 30 min |
| [7. Advanced](07-advanced/) | PID, sensors, skills auto | 60 min |
| [Appendix](appendix/) | Quick reference, troubleshooting | Reference |
...
- [VEX Robotics Extension](https://marketplace.visualstudio.com/items?itemName=vexrobotics.vexcode) installed
...
**Key Game Elements:**
- Score blocks (3 pts each)
- Control zones (6-10 pts each)
- Park robots (8 pts one, 30 pts both!)
- Descore opponent blocks (allowed!)
...
Skip to [3. Python Basics](03-python-basics/) to check your knowledge, then continue

### Path C: Just Here for Competition
Jump to [6. Competition Strategy](06-competition-strategy/) (but you may need to backtrack)

### Path D: Quick Reference
Go directly to [Appendix](appendix/) for cheat sheets and troubleshooting
...
2. Look up terms in the [Glossary](appendix/glossary.md)
3. Ask your coach or mentor
4. Visit the [VEX Forum](https://www.vexforum.com)
...
**[Start with Tutorial 0: Welcome →](00-welcome/index.md)**
